import profileb from "../assets/icons-svg/profileb.svg"
import profilew from "../assets/icons-svg/profilew.svg"
import accountsb from "../assets/icons-svg/Accountsb.svg"
import supportsb from "../assets/icons-svg/supportb.svg"
import settingsb from "../assets/icons-svg/settingsb.svg"
import edit from "../assets/icons-svg/edit.svg"
import pp from "../assets/temp/rishikesh-professional-picture.jpg"
import fb from "../assets/icons-svg/facebook.svg"
    ...
    return (
        ...
        <div className="flex">
            <div className="w-2/12 p-6 pt-12">
                <h1 className="text-center pb-6 text-[30px] font-semibold">Homepage</h1>
                <ul className="text-[22px]">
                    <li className="w-8/12 flex cursor-pointer bg-boxColor text-white p-3 rounded-3xl"><img className="ml-2 w-4 mr-4" src={profilew} alt="" />Homepage</li>
                    <li className="w-8/12 flex cursor-pointer p-3"><img className="ml-2 w-4 mr-4" src={accountsb} alt="" />Accounts</li>
                    <li className="w-8/12 flex cursor-pointer p-3"><img className="ml-2 w-4 mr-4" src={settingsb} alt="" />Settings</li>
                    <li className="w-8/12 flex cursor-pointer p-3" onClick={onLogout}><img className="ml-2 w-4 mr-4" src={supportsb} alt="" />Logout</li>
                </ul>
            </div>
            <div className="w-10/12 p-12 pr-28 bg-backgroundColor flex h-auto rounded-3xl">
                <div className="w-4/12 mr-6 bg-white p-12 rounded-3xl">
                    <img className="w-full aspect-square object-cover rounded-xl" src={pp} alt="Homepage Picture" />
